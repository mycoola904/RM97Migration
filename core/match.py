'''I need to include the AUTOID, GROUPID and STOPID columns in the dfMatch dataframe
I also need to write the dfMatch dataframe to a new table in the database. 
The table should have the following columns: AUTOID, GROUPID, and STOPID. The table should be named 'Matches'.
'''
